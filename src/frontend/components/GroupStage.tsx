...
export function GroupTabs({ activeTab, onChange }: GroupTabsProps) {
  ...
  return (
    <div className="inline-flex shrink-0 rounded-xl border border-white/8 bg-[#0c1115] p-1">
      {tabs.map((tab) => {
        ...
        return (
          <button
            ...
            className={`min-h-8 rounded-lg px-3 text-xs font-black transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#7ff0b2]/70 ${
              isActive
...
export function GroupStageCard({
  ...
  return (
    <section className="min-w-0 overflow-hidden rounded-2xl border border-white/8 bg-[#0f1317]/92">
      <div className="flex flex-col gap-2 border-b border-white/6 bg-[#13181d] px-2.5 py-2 sm:flex-row sm:items-center sm:justify-between md:px-3">
