  ...
  return (
    <>
      <button
        ...
        className="fixed left-3 top-3 z-40 inline-flex h-11 w-11 items-center justify-center rounded-2xl border border-white/10 bg-[#10151a]/95 text-white shadow-[0_10px_30px_rgba(0,0,0,0.35)] backdrop-blur transition hover:border-[#7ff0b2]/40 lg:hidden"
      ...
      {isSidebarOpen ? (
        <div className="fixed inset-0 z-50 lg:hidden">
          ...
          <div
            ref={sidebarRef}
            className="absolute bottom-0 left-0 top-0 w-[min(86vw,320px)] overflow-y-auto border-r border-white/10 bg-[#0f1317] p-3 shadow-[18px_0_50px_rgba(0,0,0,0.45)]"
          >
