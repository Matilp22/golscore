...
export default function AppShell({ auth, children }: AppShellProps) {
  ...
  return (
    <>
      ...
      <div className="mx-auto grid w-full max-w-none gap-4 px-2.5 pb-4 pt-16 sm:px-3 md:px-5 md:pb-6 md:pt-16 lg:max-w-7xl lg:grid-cols-[210px_minmax(0,1fr)] lg:pt-4">
