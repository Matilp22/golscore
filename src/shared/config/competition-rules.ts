...
export const COMPETITION_RULES: CompetitionRule[] = [
  ...
  leagueRule({
    ...
    showAnnualTable: false,
    qualificationRules: [
      { from: 1, to: 1, label: 'Final por el primer ascenso', tone: 'title' },
      { from: 2, to: 8, label: 'Reducido por el segundo ascenso', tone: 'playoff' },
    ],
    relegationRules: [
      { from: 17, to: 18, label: 'Descenso', tone: 'relegation' },
    ],
    legendItems: [
      { label: 'Final por el primer ascenso', tone: 'title' },
      { label: 'Reducido por el segundo ascenso', tone: 'playoff' },
      { label: 'Descenso', tone: 'relegation' },
    ],
    playoffRules: [
      'Dos zonas: los primeros juegan la final por el primer ascenso.',
      'Del 2 al 8 de cada zona clasifican al reducido por el segundo ascenso.',
      'Los últimos dos de cada zona descienden.',
    ],
  ...
  leagueRule({
    ...
    showAnnualTable: false,
    qualificationRules: [
      { from: 1, to: 1, label: 'Ascenso directo', tone: 'title' },
      { from: 2, to: 9, label: 'Reducido por el segundo ascenso', tone: 'playoff' },
    ],
    relegationRules: [
      { from: 21, to: 22, label: 'Descenso', tone: 'relegation' },
    ],
    legendItems: [
      { label: 'Ascenso directo', tone: 'title' },
      { label: 'Reducido por el segundo ascenso', tone: 'playoff' },
      { label: 'Descenso', tone: 'relegation' },
    ],
    sourceUsed: [apiDescriptionSource, supabaseSource, 'AFA divisional rules'],
    warnings: ['Regla 2026: 1° asciende, 2° a 9° reducido y últimos dos descienden.'],
  }),
  leagueRule({
    ...
    warnings: ['Cuatro grupos A-D; sin referencias de ascenso/descenso en tabla.'],
  }),
  leagueRule({
    ...
    qualificationRules: [
      { from: 1, to: 1, label: 'Final por el primer ascenso', tone: 'title' },
      { from: 2, to: 7, label: 'Playoffs por el segundo ascenso', tone: 'playoff' },
    ],
    relegationRules: [
      { from: 14, to: 14, label: 'Repechaje por el descenso', tone: 'relegationPlayoff' },
    ],
    legendItems: [
      { label: 'Final por el primer ascenso', tone: 'title' },
      { label: 'Playoffs por el segundo ascenso', tone: 'playoff' },
      { label: 'Repechaje por el descenso', tone: 'relegationPlayoff' },
    ],
    sourceUsed: [apiDescriptionSource, supabaseSource, 'AFA divisional rules'],
