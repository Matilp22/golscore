...
export async function saveMatchDetailsAction(formData: FormData) {
  ...
  try {
    await updateAdminMatchDetails({
      ...
      homePrimaryColor: readOptionalString(formData, 'homePrimaryColor'),
      homeSecondaryColor: readOptionalString(formData, 'homeSecondaryColor'),
      homeNumberColor: readOptionalString(formData, 'homeNumberColor'),
      homeGoalkeeperPrimaryColor: readOptionalString(formData, 'homeGoalkeeperPrimaryColor'),
      homeGoalkeeperSecondaryColor: readOptionalString(formData, 'homeGoalkeeperSecondaryColor'),
      homeGoalkeeperNumberColor: readOptionalString(formData, 'homeGoalkeeperNumberColor'),
      awayPrimaryColor: readOptionalString(formData, 'awayPrimaryColor'),
      awaySecondaryColor: readOptionalString(formData, 'awaySecondaryColor'),
      awayNumberColor: readOptionalString(formData, 'awayNumberColor'),
      awayGoalkeeperPrimaryColor: readOptionalString(formData, 'awayGoalkeeperPrimaryColor'),
      awayGoalkeeperSecondaryColor: readOptionalString(formData, 'awayGoalkeeperSecondaryColor'),
      awayGoalkeeperNumberColor: readOptionalString(formData, 'awayGoalkeeperNumberColor'),
